# data preprocessing: extra cleaning and text normalization steps on the ingested data
...
def main():
    try:
        # Fetch the data from dataset/raw
        ...
        # Store the data inside dataset/interim
        data_path = os.path.join("./dataset", "interim")
